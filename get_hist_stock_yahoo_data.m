function [hist_date, hist_high, hist_low, hist_open, hist_close, hist_vol] = get_hist_stock_yahoo_data(stock_symbol, num_month)


% Define starting year (the further back in time, the longer it takes to download)
% start_year = '2004'; % unless we want explicite define


% Get current date
[this_year, this_month, this_day, dummy, dummy] = datevec(date);
start_month = this_month - num_month;
...
url_string = strcat(url_string, '&g=d&a=', num2str(start_month-1), '&b=1');
